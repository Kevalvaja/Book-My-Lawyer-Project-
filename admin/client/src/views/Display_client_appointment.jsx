...
export default function Display_client_appointment() {
  ...
  const[case_status,setCase_status]=useState(1);
  let i=1; 
    ...
    <div>
      {role>0 && role<2 ?(
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
                <h5 class="card-title">Manage Client Appointment</h5>

                <div class="col-12">
                      <button type='button' class="btn btn-primary float-start mb-3 rounded-pill" onClick={client_appointment}><i class="bi bi-person-plus"></i><b>Add Client Appointment</b></button>
                </div>   
          ...
          <div class="card">
            <div class="card-body">
                ...
                <tbody>
                    {appointments.map((appointment)=>
                      <>
                        {appointment.case_status>0 && appointment.case_status<2 ?  
                        <tr>                           
                            <th>{i++}</th>
                            <td>{appointment.client_name}</td>
                            <td>{appointment.name}</td>
                            ...
                            <div class="col-md-6">
                                      {case_status>0 && case_status<2 ? 
                                        <>
                                        <button type='submit' class='btn btn-success rounded-pill' style={{marginRight: "10px"}} onClick={()=>update_caseStatus(appointment.appointment_id,2)}>Approve</button>
