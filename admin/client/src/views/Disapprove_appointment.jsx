...
export default function Disapprove_appointment() {
  ...
  const[case_status,setCase_status]=useState(3);
  let i=1; 
            ...
            <div class="card-body">
                ...
                <tbody>
                    {appointments.map((appointment)=>
                      <>
                        {appointment.case_status>2 && appointment.case_status<4 ?  
                        <tr>
                            <th>{i++}</th>
                            ...
                            <div class="col-md-6">
                                      ...
                                      <>
                                        ...
                                        <button type="submit" class="btn btn-success rounded-pill" onClick={()=>update_caseStatus(appointment.appointment_id,2)}>Approve</button>
                                      </>
                                    :""}</div>
                            : ""}
                            </td>
